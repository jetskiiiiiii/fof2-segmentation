...
def get_fof2_metrics_per_month_time(path_to_numeric_csv_dir: str, path_to_manual_dir: str, path_to_save: str):
    """
    Getting metrics per time slot, grouping all days of the month together.
    ...
    for month in files_by_month.keys():
        ...
        man_fof2_df.to_csv(f"{path_to_save}/man_fof2_df_per_time.csv")
        num_fof2_df.to_csv(f"{path_to_save}/num_fof2_df_per_time.csv")

        # Making sure that both DFs matchup
        assert len(man_fof2_df) == len(num_fof2_df)
        ...
        for time in timeframes_analog[1:]:
            ...
            total_values = len(man_fof2_flat)
            ...
            # Calculating RSE
            mean_manual = sum(man_fof2_flat) / total_values
            ...
            gmin = min(num_fof2_flat)
            gmax = max(num_fof2_flat)
            grange = gmax-gmin

            correlation_matrix = np.corrcoef(man_fof2_flat, num_fof2_flat)
            r = correlation_matrix[0, 1]
    ...
    # Convert final metric dicts to csv and save
    print("Getting final CSVs")
    pd.DataFrame(final_RSE, index=timeframes_analog[1:]).to_csv(f"{path_to_save}/fof2_RSE_per_time.csv")
    pd.DataFrame(final_RMSE, index=timeframes_analog[1:]).to_csv(f"{path_to_save}/fof2_RMSE_per_time.csv")
    pd.DataFrame(final_MIN, index=timeframes_analog[1:]).to_csv(f"{path_to_save}/fof2_MIN_per_time.csv")
    pd.DataFrame(final_MAX, index=timeframes_analog[1:]).to_csv(f"{path_to_save}/fof2_MAX_per_time.csv")
    pd.DataFrame(final_RANGE, index=timeframes_analog[1:]).to_csv(f"{path_to_save}/fof2_RANGE_per_time.csv")
    pd.DataFrame(final_R, index=timeframes_analog[1:]).to_csv(f"{path_to_save}/fof2_R_per_time.csv")
    pd.DataFrame(final_MBE, index=timeframes_analog[1:]).to_csv(f"{path_to_save}/fof2_MBE_per_time.csv")
    print("Finished")

def get_metrics_per_season_day_night(path_to_numeric_csv_dir: str, path_to_manual_dir: str, path_to_save: str):
    """
    ...
    for month in files_by_season.keys():
        ...
        man_fmin_df.to_csv(f"{path_to_save}/man_fmin_df_per_season.csv")
        man_fof2_df.to_csv(f"{path_to_save}/man_fof2_df_per_season.csv")
        num_fmin_df.to_csv(f"{path_to_save}/num_fmin_df_per_season.csv")
        num_fof2_df.to_csv(f"{path_to_save}/num_fof2_df_perseason.csv")
    ...
    # Convert final metric dicts to csv and save
    print("Getting final CSVs")
    pd.DataFrame(final_RSE, index=timeframes_labels).to_csv(f"{path_to_save}/RSE_per_season.csv")
    pd.DataFrame(final_RMSE, index=timeframes_labels).to_csv(f"{path_to_save}/RMSE_per_season.csv")
    pd.DataFrame(final_MIN, index=timeframes_labels).to_csv(f"{path_to_save}/MIN_per_season.csv")
    pd.DataFrame(final_MAX, index=timeframes_labels).to_csv(f"{path_to_save}/MAX_per_season.csv")
    pd.DataFrame(final_RANGE, index=timeframes_labels).to_csv(f"{path_to_save}/RANGE_per_season.csv")
    pd.DataFrame(final_R, index=timeframes_labels).to_csv(f"{path_to_save}/R_per_season.csv")
    pd.DataFrame(final_MBE, index=timeframes_labels).to_csv(f"{path_to_save}/MBE_per_season.csv")
    print("Finished")

def get_fof2_metrics_per_season_day_night(path_to_numeric_csv_dir: str, path_to_manual_dir: str, path_to_save: str):
    """
    Grouping by seasons and day/night.
    ...
    # Convert final metric dicts to csv and save
    print("Getting final CSVs")
    pd.DataFrame(final_RSE, index=timeframes_labels).to_csv(f"{path_to_save}/fof2_RSE_per_season.csv")
    pd.DataFrame(final_RMSE, index=timeframes_labels).to_csv(f"{path_to_save}/fof2_RMSE_per_season.csv")
    pd.DataFrame(final_MIN, index=timeframes_labels).to_csv(f"{path_to_save}/fof2_MIN_per_season.csv")
    pd.DataFrame(final_MAX, index=timeframes_labels).to_csv(f"{path_to_save}/fof2_MAX_per_season.csv")
    pd.DataFrame(final_RANGE, index=timeframes_labels).to_csv(f"{path_to_save}/fof2_RANGE_per_season.csv")
    pd.DataFrame(final_R, index=timeframes_labels).to_csv(f"{path_to_save}/fof2_R_per_season.csv")
    pd.DataFrame(final_MBE, index=timeframes_labels).to_csv(f"{path_to_save}/fof2_MBE_per_season.csv")
    print("Finished")
...
if __name__ == "__main__":
    ...
    path_to_save_metrics_per_month_time = f"./evaluations/{version}/{erase_type}/per_time/"
    get_fof2_metrics_per_month_time(path_to_save_prepared_numeric_csv_dir, path_to_save_prepared_manual_dir, path_to_save_metrics_per_month_time) 
    #get_metrics_per_month_time(path_to_save_prepared_numeric_csv_dir, path_to_save_prepared_manual_dir, path_to_save_fof2_metrics_per_month_time) 

    path_to_save_metrics_per_season = f"./evaluations/{version}/{erase_type}/per_season/"
    get_fof2_metrics_per_season_day_night(path_to_save_prepared_numeric_csv_dir, path_to_save_prepared_manual_dir, path_to_save_metrics_per_season) 
